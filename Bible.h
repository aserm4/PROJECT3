...
{	
   private:
      ...
      map<Ref, int> index;   // map to store reference and file offset
      void buildIndex();     // function to build the reference index
   ...
   public:
      ...
      int lookupOffset(const Ref ref);  // return byte offset for testing
};
